def main():
    # Lista para armazenar as idades e nomes das pessoas
    pessoas = []
    # Recebendo as informações das pessoas
    for i in range(4):
    ...
    # Verificando quem está acima da média de idade
    abaixo_media_nomes = [nome for nome, idade in pessoas if idade > media_idade]
    # Verificando quantas pessoas estão abaixo da média de idade
    abaixo_media = 0
    for nome, idade in pessoas:
